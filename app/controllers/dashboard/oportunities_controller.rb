class Dashboard::OportunitiesController < Dashboard::AuthenticatedController
  ...
  def create
    ...
    respond_to do |format|
      if @oportunity.save
        format.html { redirect_to dashboard_oportunities_url, notice: 'Oportunidade criada com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @oportunity.update(oportunity_params)
        format.html { redirect_to dashboard_oportunities_url, notice: 'Oportunidade atualizada com sucesso!' }
  ...
  def destroy
    @oportunity.destroy
    respond_to do |format|
      format.html { redirect_to dashboard_oportunities_url, notice: 'Oportunidade removida com sucesso!' }
